---
description: Builds frontend UI components, layouts, and pages with accessibility and responsiveness. Use for React, Svelte, Vue, Astro, or vanilla HTML/CSS/JS UI work.
mode: subagent
temperature: 0.2
permission:
  edit: allow
